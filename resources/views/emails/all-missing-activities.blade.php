                ...
                <tr>
                    <td style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                        ...
                        <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                            O sistema Delos Project indentificou algumas notificações referente aos colaboradores.
                        </p>

                        <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                            <span class="bold" style="font-weight: bold;">Horas totais pendentes:</span> {{$totalHours}}
                        </p>

                        <br>
                        <p>Abaixo a lista dos colaboradores com pendências</p>

                        <table class="table table-bordered table-striped" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th style="border: 1px solid #ddd;border-bottom-width: 2px;border-bottom-color: #66BB6A;padding: 13px;">Colaborador</th>
                                    <th style="border: 1px solid #ddd;border-bottom-width: 2px;border-bottom-color: #66BB6A;padding: 13px;">Email</th>
                                    <th style="border: 1px solid #ddd;border-bottom-width: 2px;border-bottom-color: #66BB6A;padding: 13px;">Horas pendentes</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($collaborators as $collaborator)
                                    @if($collaborator->missingActivities->sum('hours') > 0)
                                        <tr>
                                            <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$collaborator->name}}</td>
                                            <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$collaborator->email}}</td>
                                            <td class="bold dct-color" style="font-weight: bold;color: #1b5e20;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$collaborator->missingActivities->sum('hours')}}</td>
                                        </tr>
                                    @endif
                            </tbody>
                            @endforeach
                        ...
                        <p class="bold dct-color" style="font-weight: bold;color: #333333;">OBS. Os colaboradores listados já receberam um e-mail de notificação de suas pendências.</p>
