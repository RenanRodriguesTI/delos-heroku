                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" class="display-width-child" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p>{{ $responsibleName }} recusou uma tarefa sua. Abaixo as informações da tarefa:</p>


                            <table class="table table-bordered table-striped" style="width: 100%;">
                                <tbody>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Projeto:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->project->full_description}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Data:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->date->format('d/m/Y')}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Horas:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->hours}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Tarefa:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->task->name}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Local:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->place->name}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Observação:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->note}}</td>
                                </tr>
                                <tr>
                                    <td class="bold" style="font-weight: bold;border: 1px solid #ddd;padding: 8px;vertical-align: middle;">Criado em:</td>
                                    <td style="border: 1px solid #ddd;padding: 8px;vertical-align: middle;">{{$activity->created_at->format('d/m/Y H:i:s')}}</td>
                                </tr>
                                </tbody>
                            </table>
