        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-lg-2 nopadding">
                    <div class="form-group">
                        {!!
                       Form::select('providers[]', $providers, Request::input('providers'), [
                            'id' => 'form-control',
                            'class' => 'form-control selectpicker nopadding',
                            'title' => 'Selecione o(s) fornecedor(es)',
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @can('payment-write-offs-expense')
                                <li>
                                    <a data-toggle='modal' data-target='#modal-report-supplier-paymentWriteOffs'>
                                    <span class="glyphicon glyphicon-cloud-download"></span>
                                      Baixa de Pagamentos  
                                    </a>
                                </li>
                            @endcan
                            @can('apportionments-supplier-expense')
                                <li>
                                    <a data-toggle='modal' data-target='#modal-report-supplier-apportionments'>
                                    <span class="glyphicon glyphicon-cloud-download"></span>
                                      Rateios Lançamentos  
                                    </a>
                                </li>
