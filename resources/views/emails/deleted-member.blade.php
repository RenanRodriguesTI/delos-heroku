                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                Sua participação no projeto: <span class="bold" style="font-weight: bold;">{{$project->full_description}}</span> foi encerrada.
                            </p>

                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                Caso você tenha sido removido por engano entre em contato com o lider desse projeto <span class="bold" style="font-weight: bold;">{{$project->owner->email}}</span>.
                            </p>
