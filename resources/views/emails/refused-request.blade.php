                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                A solicitação feita pelo usuário {{$request->requester->name}} foi recusada pelo usuário {{$rejector->name}} em {{$now->format('d/m/Y')}} às {{$now->format('H:i:s')}}
                            </p>

                            <table>
                                <thead>
                                    <tr>
                                        <th style="border: 1px solid #ddd;border-bottom-width: 2px;border-bottom-color: #66BB6A;padding: 13px;">Motivo pelo qual a solicitação foi rejeitada.</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><span class="bold" style="font-weight: bold;">{{$reason}}</span></td>
                                    </tr>
                                </tbody>
                            </table>
