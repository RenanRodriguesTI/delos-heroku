    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width-inner" width="600">
        ...
        <tr>
            ...
            <td align="center" class="MsoNormal" style="color:#333; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-weight:700; text-trans form:uppercase; font-size:26px; line-height:34px; letter-spacing:1px;" data-color="Title" data-size="Title" data-min="15" data-max="46">
                Infelizmente seu pagamento não foi completado
            </td>
            <!-- END TITLE -->
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                A transação <i>Nº {{$transaction->id}}</i> não pôde se completada
                                <br>
                                Pois não recebemos o pagamento
                                <br><br><br>
                                PS: Caso tenha pago entre em contato conosco
                            </p>
