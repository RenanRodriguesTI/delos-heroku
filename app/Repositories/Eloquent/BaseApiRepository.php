...
use Delos\Dgp\Repositories\Criterias\MultiTenant\ScopeApiCriteria;
use Prettus\Repository\Criteria\RequestCriteria;
use Prettus\Repository\Eloquent\BaseRepository as BasePrettusRepository;

abstract class BaseApiRepository extends BasePrettusRepository
{
    ...
    {
        $this->pushCriteria(ScopeApiCriteria::class);
