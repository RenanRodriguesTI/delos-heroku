                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                A solicitação <span class="bold" style="font-weight: bold;">{{$request->id}}</span> foi requisitada pelo usuário: <span class="bold" style="font-weight: bold;">{{$request->requester->name}}</span> em <span class="bold" style="font-weight: bold;">{{$request->created_at->format('d/m/Y')}}</span> às <span class="bold" style="font-weight: bold;">{{$request->created_at->format('H:i:s')}}</span>.
                            </p>

                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">

                                Acesse já o <a href="{{route('requests.show', ['id' => $request->id])}}" class="bold dct-color" style="font-weight: bold;color: #4AC355;">Delos Project</a> para saber mais.
                            </p>
