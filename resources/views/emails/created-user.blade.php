                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <table class="table" style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td class="bold" style="font-weight: bold;padding: 8px;vertical-align: middle;">Login:</td>
                                        <td style="padding: 8px;vertical-align: middle;">{{$user->email}}</td>
                                    </tr>
                                    <tr>
                                        <td class="bold" style="font-weight: bold;padding: 8px;vertical-align: middle;">Senha:</td>
                                        <td style="padding: 8px;vertical-align: middle;">{{$password}}</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                               Recomendamos que você altere a senha após o primeiro acesso ao
                               <a href="{{route('home.index')}}" class="bold dct-color" style="font-weight: bold;color: #4AC355;">Delos Project</a>.
                            </p>
