                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                Lamentamos, o usuário <span class="bold" style="font-weight: bold;">{{$user->name}}</span> recusou sua folga abaixo :(
                            </p>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Data:</td>
                                    <td><span class="bold" style="font-weight: bold;">{{$rest->date->format('d/m/Y')}}</span></td>
                                </tr>
                                <tr>
                                    <td>Horas:</td>
                                    <td><span class="bold" style="font-weight: bold;">{{$rest->hours}}</span></td>
                                </tr>
                                <tr>
                                    <td>Criada em:</td>
                                    <td><span class="bold" style="font-weight: bold;">{{$rest->created_at->format('d/m/Y H:i:s')}}</span></td>
                                </tr>
                                </tbody>
                            </table>
