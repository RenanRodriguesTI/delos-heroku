...
class ProjectService extends AbstractService
    {
        ...
        public function create(array $data)
        {
            ...
            $alocations = app(AllocationService::class)->generate([
                'project_id' => $project->id,
                'user_id' =>$project->owner_id,
                'group_company_id' => $project->owner->group_company_id,
                'start' =>  $project->start->format('d/m/Y'),
                'finish' => $project->finish->format('d/m/Y'),
        ...
        public function update(array $data, $id)
        {
            ...
            // $extension = $originalProject->extension ? $originalProject->extension->format('d/m/Y'):null;

            // if($extension != $data['extension'] || $originalProject->budget != $data['budget']){
            //     $this->event->fire(new DispatchAutoAllocation($originalProject,$editedProject));
            // }

            if($originalProject->owner_id != $editedProject->owner_id){
                $this->event->fire(new UpdateOwnerProject($originalProject,$editedProject));
            }
