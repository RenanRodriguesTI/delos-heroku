...
@section('content')
    ...
    <div class="container">
	    ...
	    <div class="panel-heading">
	        <h3 class="panel-title bold">Editar Tipo de despesa: {{$expenseType->name}}</h3>
	    </div>
	    <div class="panel-body">
        {!! Form::open(['route' => ['expenseTypes.update', 'id' => $expenseType->id], 'method' => 'PUT']) !!}
        {!! Form::hidden('id', $expenseType->id)!!}
