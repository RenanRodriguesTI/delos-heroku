<?php
    ...
    use Delos\Dgp\Repositories\Eloquent\ActivityApiRepositoryEloquent;
    ...
    class ActivityApiService extends AbstractService
    {
        ...
        {
            return ActivityApiRepositoryEloquent::class;
        }
