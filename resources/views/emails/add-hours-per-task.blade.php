                    ...
                    <tr>
                        ...
                        <!-- CONTENT -->
                            ...
                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                O Projeto <span class="bold" style="font-weight: bold;">{{$project->compiled_cod}}</span> foi criado em <span class="bold" style="font-weight: bold;">{{$project->created_at->format('d/m/Y')}}</span> às <span class="bold" style="font-weight: bold;">{{$project->created_at->format('H:i:s')}}</span>.
                            </p>

                            <p style="color:#666666; font-family:Segoe UI, Helvetica Neue, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; line-height:24px; mso-line-height-rule:exactly;">
                                Acesse o <a href="{{route('projects.edit', ['id' => $project->id])}}#edit_hours_per_tasks" class="bold dct-color" style="font-weight: bold;color: #4AC355;">Delos Project</a> para adicionar as horas por tarefa.
                            </p>
